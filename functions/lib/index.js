...
exports.linkEmailToUser = exports.verifyOTP = exports.sendOTP = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
const nodemailer = require("nodemailer");
admin.initializeApp();
const db = admin.firestore();
const GMAIL_USER = (_a = process.env.GMAIL_USER) !== null && _a !== void 0 ? _a : '';
const GMAIL_PASS = (_b = process.env.GMAIL_PASS) !== null && _b !== void 0 ? _b : '';
...
exports.sendOTP = functions.https.onRequest(async (req, res) => {
    ...
    const email = normalizeEmail((_a = req.body.email) !== null && _a !== void 0 ? _a : '');
...
exports.verifyOTP = functions.https.onRequest(async (req, res) => {
    ...
    const email = normalizeEmail((_a = req.body.email) !== null && _a !== void 0 ? _a : '');
    const code = ((_b = req.body.code) !== null && _b !== void 0 ? _b : '').trim();
    if (!email || !code) {
    ...
    if (emailUserDoc.exists) {
        ...
        try {
            ...
            if ((e === null || e === void 0 ? void 0 : e.code) === 'auth/user-not-found') {
                ...
                console.error('[verifyOTP] getUser failed:', e === null || e === void 0 ? void 0 : e.code, e === null || e === void 0 ? void 0 : e.message);
                try {
                    await admin.auth().updateUser(uid, { email, emailVerified: true });
                }
                catch (updateErr) {
                    console.error('[verifyOTP] updateUser also failed:', updateErr === null || updateErr === void 0 ? void 0 : updateErr.code, updateErr === null || updateErr === void 0 ? void 0 : updateErr.message);
                }
            }
        }
    }
...
exports.linkEmailToUser = functions.https.onCall(async (data, context) => {
    ...
    if (emailUserDoc.exists) {
        ...
        if (existingUid !== currentUid) {
            throw new functions.https.HttpsError('already-exists', 'このメールアドレスは既に別のアカウントに登録されています');
        }
        // 同じUID：OTPを削除し、tempPasswordを発行して非匿名セッションへ移行させる
        await db.collection('otps').doc(email).delete();
        const { randomBytes: rb1 } = await Promise.resolve().then(() => require('crypto'));
    ...
    try {
        ...
        if ((e === null || e === void 0 ? void 0 : e.code) === 'auth/user-not-found') {
            ...
            console.error('[linkEmailToUser] getUser failed:', e === null || e === void 0 ? void 0 : e.code, e === null || e === void 0 ? void 0 : e.message);
            try {
                await admin.auth().updateUser(currentUid, { email, emailVerified: true });
            }
            catch (updateErr) {
    ...
    const { randomBytes: rb2 } = await Promise.resolve().then(() => require('crypto'));
